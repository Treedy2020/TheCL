...
cluster = "volcano_icl" # or "volcano_icl_concurr"
voice_type = os.environ.get("voice_id")
...
request_json = {
    ...
    "request": {
        "reqid": "xxx",
        "text": """我常常觉得我的生命中缺乏一种深厚的动力。有时我可以十分努力，但动力往往是好胜心或虚荣心，比如：别人能做到的为什么我做不到？愿意听人称赞等等。在一切顺利的时候，那动力就消失了。""",
        "text_type": "plain",
        "operation": "submit"
    }
}
