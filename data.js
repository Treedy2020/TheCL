    ...
    works: [
        {
            ...
            details: "该角色为坚强独立的少女，戏份贯穿全剧，情感表现从坚定到脆弱有着丰富变化。",
        ...
        },
        {
            ...
            details: "角色特点是知识渊博且略带神秘感，需要在温柔和严厉之间自然切换。",
        ...
        },
        {
            ...
            typeName: "电影",
            title: "《战玄武》",
            image: "./public/image4.webp", // Placeholder path
            role: "女主",
        ...
        },
        {
            ...
            typeName: "电影",
            title: "《守钻狙击》",
            image: "./public/image5.jpg", // Placeholder path
            role: "女主",
        ...
        },
        {
            ...
            typeName: "有声漫",
            title: "《王爷你好啊》",
            image: "./public/voicecomics/wynh.jpg", // Placeholder path
            role: "女主",
            description: "Bilibili出品的有声漫画作品",
            details: "古装题材的有声漫画，在作品中担任女主角配音工作。",
        ...
        // 广播剧 (Radio Dramas)
        {
            ...
            typeName: "广播剧",
            title: "《清平乐》",
            image: "./public/radiodramas/qpl.jpg", // Placeholder path
            role: "太子妃",
            description: "百合Hub出品的广播剧作品",
            details: "古装题材广播剧，改编自同名电视剧，担任太子妃角色配音。",
            link: "https://www.baihe.com/", // Placeholder
            linkText: "百合Hub官网"
        },
        {
            year: 2021, // Estimated
            ...
            typeName: "广播剧",
            title: "《我的男友不是人》",
            image: "./public/radiodramas/wdnybsr.jpg", // Placeholder path
            role: "女主",
            description: "QQ音乐出品的广播剧作品",
            details: "奇幻题材广播剧，讲述女主角与非人类男友的故事。",
            link: "https://y.qq.com/",
            linkText: "QQ音乐官网"
        },
        {
            ...
            typeName: "广播剧",
            title: "《不忧雅》",
            image: "./public/radiodramas/bya.jpg", // Placeholder path
            role: "女主",
            description: "QQ音乐出品的广播剧作品",
        ...
        },
        {
            ...
            typeName: "广播剧",
            title: "《次元突破！》",
            image: "./public/radiodramas/cytp.jpg", // Placeholder path
            role: "女主",
            description: "QQ音乐出品的广播剧作品",
        ...
        // 有声书 (Audiobooks)
        {
            ...
            typeName: "有声书",
            title: "《病君的小邪后》",
            image: "./public/audiobooks/bjdxxh.jpg", // Placeholder path
            role: "女主",
            description: "热门网络小说有声书，🔥标记表示作品广受欢迎",
            details: "古风言情小说改编的有声书，担任女主角配音。",
            link: "https://example.com/bjdxxh",
            linkText: "试听链接"
        },
        {
            year: 2019, // Estimated
            ...
            typeName: "有声书",
            title: "《爵迹》",
            image: "./public/audiobooks/jj.jpg", // Placeholder path
            role: "女主",
        ...
        },
        {
            ...
            typeName: "有声书",
            title: "《欢颜》",
            image: "./public/audiobooks/hy.jpg", // Placeholder path
            role: "女主",
            description: "官方授权小说有声书，👑标记表示官方认证作品",
        ...
        },
        {
            ...
            typeName: "有声书",
            title: "《惊蛰》",
            image: "./public/audiobooks/jz.jpg", // Placeholder path
            role: "女主",
        ...
        },
        {
            ...
            typeName: "有声书",
            title: "《天才玩偶》",
            image: "./public/audiobooks/tcwo.jpg", // Placeholder path
            role: "配音",
        ...
        },
        {
            ...
            typeName: "有声书",
            title: "《隐匿者》",
            image: "./public/audiobooks/ynz.jpg", // Placeholder path
            role: "配音",
            description: "悬疑题材小说有声书",
